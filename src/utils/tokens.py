...
def encode_jwt(payload: Dict, key: str = JWT_SECRET, algorithm: str = JWT_ALGORITHM) -> str:
...
def decode_jwt(token: str, key: str = JWT_SECRET, algorithm: str = JWT_ALGORITHM) -> Dict:
